  ...
  return (
    <header style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50, borderBottom: "1px solid #1a1a1a", backgroundColor: "rgba(0,0,0,0.9)", backdropFilter: "blur(8px)" }}>
      <nav style={{ maxWidth: "1152px", margin: "0 auto", height: "80px", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px" }}>
        ...
        {/* Desktop nav — verborgen op mobiel via CSS */}
        <ul className="hidden md:flex" style={{ alignItems: "center", gap: "32px", listStyle: "none", margin: 0, padding: 0 }}>
        ...
        <button
          ...
          style={{ flexDirection: "column", gap: "5px", padding: "8px", background: "none", border: "none", cursor: "pointer", WebkitTapHighlightColor: "transparent" }}
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className="md:hidden" style={{ borderTop: "1px solid #1a1a1a", backgroundColor: "#000000" }}>
